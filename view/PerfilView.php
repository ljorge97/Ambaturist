...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-sm navbar-dark sticky-top" style="background-color: green;">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 offset-md-3" style="padding-top: 15px">
                <div class="row">
                    ...
                    <?php if($usuario->id==$_SESSION["id"]){ ?>
                            <a class="btn btn-outline-success" class="btn btn-outline-success"href="<?php echo $helper->url("post","index"); ?>">Agregar Post</a>
                            <?php }
                            if(isset($allPost)){
